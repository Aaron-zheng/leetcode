...
public class StringToIntegerAtoi {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new StringToIntegerAtoi().myAtoi("42"));
        System.out.println(new StringToIntegerAtoi().myAtoi("23123 aaaaa"));
        System.out.println(new StringToIntegerAtoi().myAtoi("aaa 123123"));
        System.out.println(new StringToIntegerAtoi().myAtoi("-91283472332"));
        System.out.println(new StringToIntegerAtoi().myAtoi("   +0 123"));
        System.out.println(new StringToIntegerAtoi().myAtoi("   - 123"));
    }
    ...
    public int myAtoi(String str) {
        ...
        boolean hasPositiveFlag = false;
        for(Character c : str.toCharArray()) {
            if(c.equals(' ') && result.length() == 0 && !hasPositiveFlag) {
                continue;
            }
            if(c.equals('-') && result.length() == 0 && !hasPositiveFlag) {
                positive = false;
